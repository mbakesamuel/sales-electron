...
export declare const PERMISSION_ACTIONS: readonly ["validate_sales", "direct_validate_sales", "validate_delivery_orders", "cancel_validated_delivery_order", "transfer_delivery_order_balance", "validate_vehicle_consignment_notes", "manage_permissions", "draft_stock_receipts", "post_stock_receipts", "draft_stock_transfers", "post_stock_transfers", "draft_stock_adjustments", "post_stock_adjustments", "direct_post_stock_receipts", "direct_post_stock_transfers", "validate_stock_documents"];
