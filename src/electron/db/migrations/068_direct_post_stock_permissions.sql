...
INSERT OR IGNORE INTO RoleActionPermission (role, actionKey, allowed) VALUES
  ...
  ('STATISTICS_SUPERVISOR', 'direct_post_stock_receipts', 0),
  ('STATISTICS_SUPERVISOR', 'direct_post_stock_transfers', 0),
  ('SALES_CLERK', 'direct_post_stock_receipts', 0),
  ('SALES_CLERK', 'direct_post_stock_transfers', 0);
